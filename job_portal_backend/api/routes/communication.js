...
router.get('/announcements/drafts', protect, admin, communicationController.getDraftAnnouncements.bind(communicationController));
router.get('/announcements/scheduled', protect, admin, communicationController.getScheduledAnnouncements.bind(communicationController));
router.put('/announcements/:id', protect, admin, communicationController.updateAnnouncement.bind(communicationController));
router.delete('/announcements/:id/cancel', protect, admin, communicationController.cancelScheduledAnnouncement.bind(communicationController));
